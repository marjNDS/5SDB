...
-- Ordem respeitada por causa das chaves estrangeiras.
-- =============================================================================
...
DELETE FROM produtos_em_falta WHERE codigo_pedido = 'abc999';
DELETE FROM clientes         WHERE codigo_comprador IN ('123','789');
DELETE FROM produtos         WHERE sku IN ('brinq456rio','brinq789rio','roupa123rio');
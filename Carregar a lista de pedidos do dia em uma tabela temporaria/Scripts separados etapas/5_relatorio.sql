-- =============================================================================
-- PASSO 5 DE 6: RELATÓRIO FINAL — PEDIDOS DO DIA (DO MAIS CARO AO MAIS BARATO)
-- Executar após o passo 4.
-- Exibe os pedidos do dia com dados do cliente e da expedição,
